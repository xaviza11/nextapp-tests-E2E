...
describe('Create Flight Route', () => {

    test('route has been created', async () => {
        try{
    ...
    test('create flight throw error when full route is invalid', async () => {
        try {
            const res = await axios.post(host + 'api/auth/authenticate', {
                email: "test@test.com",
                password: "A1aAAAAAAAAAAAAA",
            ...
            expect(error.response.data.message).toBe( "Full Route has not valid format")
        }
    })

    test('route points not contain invalid coordintaes', async () => {
