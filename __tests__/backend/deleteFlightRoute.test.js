...
const url = 'api/flightRoutes/deleteRoute'
const axios = require('axios')

describe('Delete Flight Route', () => {

    test('route has been deleted', async () => {
            ...
            const result = await axios.post(host + 'api/flightRoutes/newRoute', {
                "departure": "LERS",
                "arrival": "LIRQ",
            ...
            const deleted = await axios.post(host + url, {
